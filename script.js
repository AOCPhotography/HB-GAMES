...
let currentGame = 1;
let usedGames = {}; // Tracks used sub-games per category
  ...
  1: [
    {
      name: "RULES",
      games: [
        { name: "National Geographic (Everything is a David Attenborough inspired moment)" },
        { name: "Sex Ex" },
        { name: "No Swearing" },
        { name: "Everything Has to Be Sung" },
        { name: "Questions Only" },
        { name: "Alien Abduction" },
        { name: "Job Interview" },
        { name: "Inner Monologue Mode" },
        { name: "Royalty" },
        { name: "Washed-up Magician" },
        { name: "Yes, But" },
        { name: "Lie Detector" },
        { name: "Orchestra" },
        { name: "Local News Anchors" },
        { name: "Crazy Person on the TTC" },
        { name: "Red Flag Dating" },
        { name: "Mime Time" },
        { name: "Ghost Mode" },
        { name: "Uno Reverse" },
        { name: "The Rule Maker" },
    ...
    },
    {
      ...
      games: [{ name: "Pitch a random product" }]
    },
    {
      name: "FAKE TED TALK",
      games: [
  ...
  2: [
    {
      ...
      games: [
        ...
        { name: "Chip-dust Finger Covers", image: "assets/game_images/chip_finger_covers.jpg", price: "$19.99" },
    ...
    },
    {
      name: "AND SCENE",
      games: [
        { name: "Being Runner-up of the 2009 Air Guitar Championships" },
        { name: "Winning the 2009 Air Guitar Championships" },
        { name: "Accidentally Playing Strip Poker with Your Cousin" }
      ]
    }
  ],
  3: [
    ...
    },
    {
      ...
      games: [
        ...
        { name: "Flick It! Toss a Card into the Moving Hat" },
...
function startSpin() {
  ...
  setTimeout(() => { spinButton.classList.add('fade-out-text'); }, 1200);
  setTimeout(() => {
  ...
  setTimeout(() => {
    spinButton.onclick = () => { showGame(chosenCategory); };
  }, 6000);
}
